...
function abrirPaginaCaderno(id) {
  ...
  const fonte = p.fontSize || "14.5";
  document.getElementById("caderno-fonte").value = fonte;
  elCadernoArea.style.fontSize = fonte + "px";
...
function salvarPaginaAtual() {
  ...
  p.fontSize = document.getElementById("caderno-fonte").value;
...
document.getElementById("caderno-fonte").addEventListener("change", (e) => {
  elCadernoArea.style.fontSize = e.target.value + "px";
  salvarPaginaAtual();
});
