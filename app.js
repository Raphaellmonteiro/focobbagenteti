...
document.getElementById("btn-pratica-sair").addEventListener("click", fecharPratica);
...
document.getElementById("input-importar").addEventListener("change", (e) => {
  ...
  reader.onload = () => {
    try {
      ...
      const normalizados = dados.map(q => ({ origem: "prova", grupo: "", volatil: false, alternativas: {}, imagem: "", imagemTipo: "", ...q }));
